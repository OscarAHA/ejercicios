...
public class Tangentejdbc {
    ...
    public static void main(String[] args)throws SQLException{
        ...
        ResultSet rs  =null;
        String sql = "select tan(?);";

        System.out.println(sql);
        int var=Integer.parseInt(JOptionPane.showInputDialog("Digite el valos a sacar tamgente"));
